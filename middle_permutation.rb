def middle_permutation(string)
  ...
  perm_arr = string_arr.permutation(string_arr.length).to_a.map {|arr| arr.join}.sort
...
middle_permutation("abcdf")
middle_permutation("abcdef")
#middle_permutation("abcdefghij")
